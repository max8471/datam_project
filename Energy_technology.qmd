...
#| echo: false
#| message: false
ggplot(filtered_G7, aes(x = Year, y = Spending_normalized, color = Technology)) +
  geom_line()+
  labs(title = "Spending on various energy technologies for G7 (1974-2022)",
       ...
       color = "Technology")
```
Now let's plot it without the nuclear to have a better view on the other variables
...
#| echo: false
#| message: false
ggplot(G7_wonuc, aes(x = Year, y = Spending_normalized, color = Technology)) +
  geom_line() +
  labs(title = "Spending on various energy technologies for G7 (nuclear excluded) (1974-2022)",
       x = "Year",
       y = "Spending (per millage of the GDP)",
       color = "Technology")
```
To highlight the interest of the transformation, let's have a look at what it would have looked like with non normalized values

```{r}
#| echo: false
#| message: false
G7_nonnorm <- g7_summary_df0 |>
  filter(Technology %in% c("Fossil fuels", "Renewables","Nuclear", "Energy efficiency","Hydrogen and fuel cells","Other cross-cutting technologies/research","Other power and storage technologies"))

ggplot(G7_nonnorm, aes(x = Year, y = Spending, color = Technology)) +
  geom_line() +
  labs(title = "NON NORMALIZED Spending on various energy technologies for G7 (1974-2022)",
       x = "Year",
       y = "Spending (per millage of the GDP)",
       color = "Technology")
```
...
#| echo: false
#| message: false
G7_wonuc_nonnorm <- g7_summary_df0 |>
  filter(Technology %in% c("Fossil fuels", "Renewables","Energy efficiency","Hydrogen and fuel cells","Other cross-cutting technologies/research","Other power and storage technologies"))

ggplot(G7_wonuc_nonnorm, aes(x = Year, y = Spending, color = Technology)) +
  geom_line() +
  labs(title = "NON NORMALIZED Spending on various energy technologies for G7 (nuclear excluded) (1974-2022)",
       x = "Year",
       y = "Spending (per millage of the GDP)",
       color = "Technology")
```
