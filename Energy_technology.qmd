...
## Correlation between GDP and Total budget
We suspect GDP and the amount allocated to public RD&D to be correlated. To find out if it is, we are going to look at the R-squared, for each year, of the linear regression between the Total Budget and the GDP.
...
ggplot(r_squared_results, aes(x = Year, y = R_squared)) +
  ...
  geom_point() +
  ylim(0,1) +
  labs(title = "R-squared values over the years",
       x = "Year",
       y = "R-squared")
...
ggplot(coefficients_results, aes(x = Year, y = Coefficient)) +
  geom_line() +
  geom_point() +
  labs(title = "Coefficient values over the years",
       x = "Year",
       y = "Coefficient")
```
